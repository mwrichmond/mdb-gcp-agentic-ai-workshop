...
<div><p>If you followed the naming suggested in <a href="SETUP.md">SETUP.md</a> the directory should be <em>adk_agents</em>.</p></div>
...
<p>From the <em>adk_agents</em> directory, execute the command below.</p>
